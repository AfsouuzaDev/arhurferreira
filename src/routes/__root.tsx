...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CYBER//SORT_DECK — Algoritmos de Ordenação" },
      { name: "twitter:title", content: "CYBER//SORT_DECK — Algoritmos de Ordenação" },
      { property: "og:description", content: "Dashboard didático cyberpunk para algoritmos de ordenação com PokéAPI." },
      { name: "twitter:description", content: "Dashboard didático cyberpunk para algoritmos de ordenação com PokéAPI." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8b23bc6c-4d19-4cc7-8b7c-56649f8dd7af/id-preview-6d102c9d--4d11881e-d362-4356-a439-dac23134fd09.lovable.app-1779568616969.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8b23bc6c-4d19-4cc7-8b7c-56649f8dd7af/id-preview-6d102c9d--4d11881e-d362-4356-a439-dac23134fd09.lovable.app-1779568616969.png" },
